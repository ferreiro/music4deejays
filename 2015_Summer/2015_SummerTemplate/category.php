        ...
        <div class="middle">
            <div class="middle__ajax">
                ...
                <h2 class="content__title">
                    Best <span><? echo $MaincategoryName; ?></span> songs for deejays
                </h2>
            ...
            <div class="sidebar__ajax">
                ...
                <div class="sidebar__chart genericBox">
                    <div class="sidebar__chart__content">
                        <h3 class="sidebar__chart__title">Best 6 <? echo $MaincategoryName; ?> this week</h3>
                        <ul>
                            <?php
                ...
                <div class="sidebar__chart genericBox">
                    Hey Fan del dubstep, no te pierdas las nuevas canciones! Siguenos.
                    <img src="http://www.easyacc.com/blog/wp-content/uploads/2014/09/followusontwitterlogo.jpg" width="100%"  />
                </div>
