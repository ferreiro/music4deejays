...
<div class="header_wrap"><div class="header">
      ...
      <ul> 
         ...
         <li class="seleccionado"><a href="<?php echo home_url(); ?>"><p>Home</p></a></li><div class="separador"></div>
                ...
                <div class="left_box">
                        ...
                        <div class="box"><div class="box_int">
							...
							<div class="category_content">
							    ...
							    <h1 class="titulo_peque">New hot music of the Day</h1>
								 
								<?php query_posts(array('orderby' => 'date', 'showposts' => 16, 'cat' => '3, -13' ));
